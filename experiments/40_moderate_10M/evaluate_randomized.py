"""
Exp 40: Moderate + 10M Steps -- fully randomized eval.
...
# Training ranges (eval samples from these)
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 40: MODERATE + 10M (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 40 (Moderate + 10M): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
