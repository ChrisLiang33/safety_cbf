"""
Exp 40: Moderate + 10M Steps -- evaluate with bias + radius noise.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 40: MODERATE + 10M STEPS (bias=0.7, error=-1.0)",
                 fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 40 (Moderate + 10M Steps): Alpha & Phi vs Distance to Nearest Obstacle (all scenarios)",
                     fontsize=14)
