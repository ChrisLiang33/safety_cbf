"""Exp 72 Phase 1: Train nav with moving obstacles."""
import time
...
if __name__ == "__main__":
    print("Exp 72 Phase 1: Nav with moving obstacles (kx, ky)")
    ...
    model.save("./models_dynamic/nav_moving_discrete05_model_v2")
    vec_env.close()
