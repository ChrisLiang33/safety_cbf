...
Experiment 25: Obstacle RADIUS ESTIMATION NOISE
  - TRUE radius = 5.0 (for collision detection)
  - ESTIMATED radius = true + error (for CBF computation)
  - Training: error ~ U(-1.0, +1.0) per obstacle per episode
  - Eval: error = -1.0 (worst case underestimate)
  - No dynamics disturbance — purely perception error

Usage:
    cd experiments/25_radius_estimation_noise
    python run_all.py
"""
import subprocess
import sys
