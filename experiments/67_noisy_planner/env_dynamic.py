"""
Exp 67: A* with noisy planner + mixed shapes -- reduced replan, high waypoint noise
...
REPLAN_INTERVAL = 200
WAYPOINT_NOISE = 5.0  # meters -- random perturbation to each A* waypoint
...
class AStarNoisyPlannerEnv(gym.Env):
