"""
3-obstacle weave, fixed alpha + proportional k_nom baseline WITH disturbance.
Same as exp 13 fixed alpha env — no phi, but with noise.
"""
...
class FixedAlphaDisturbanceEnv(gym.Env):
    def __init__(self, alpha=1.0, disturbance_scale=0.05):
        super().__init__()
        self.dt = 0.1
