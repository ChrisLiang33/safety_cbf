"""
One-shot: train phi-CBF + disturbance model then evaluate.

Usage:
    cd experiments/15_phi_cbf_disturbance
    python run_all.py
"""
import subprocess
import sys
...
SCRIPTS = [
    ("Train phi-CBF+disturbance model (kx, ky, alpha, phi)", [sys.executable, "train_dynamic.py"]),
