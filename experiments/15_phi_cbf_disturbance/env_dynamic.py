"""
3-obstacle weave with learnable phi + disturbance.
Agent controls [kx, ky, alpha, phi]. Noise added to dynamics.

CBF constraint: Lgh @ u >= -alpha * h(x) + phi * ||Lgh||^2

This combines the phi robustness term with actual disturbance to test
whether the agent learns to use phi to compensate for noise.
"""
