"""Exp 48: Fixed alpha=1.0 + higher speed + two-level sensor error + collision -250, 10M steps."""
import time
...
if __name__ == "__main__":
    print("Exp 48: Fixed alpha=1.0 + combined best (kx, ky, phi)")
    ...
    env_fns = [lambda: FixedAlphaCombinedBestEnv() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 48: {elapsed:.1f}s ({elapsed/60:.1f}min)")
