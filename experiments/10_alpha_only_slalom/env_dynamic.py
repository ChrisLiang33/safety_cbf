"""
3-obstacle slalom, alpha-only control.
Agent controls only alpha. Steering is a fixed proportional controller toward target.
This forces the agent to modulate alpha since it cannot steer around obstacles.
"""
...
class AlphaOnlySlalomEnv(gym.Env):
    def __init__(self):
        super().__init__()
        self.dt = 0.1
