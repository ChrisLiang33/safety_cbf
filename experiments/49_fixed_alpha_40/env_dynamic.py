"""
Exp 49: Fixed alpha=4.0 + combined best setup.
Agent controls [kx, ky, phi]. Alpha is FIXED at 4.0.

Alpha=4.0 is much more aggressive than 1.0 — it allows a smaller set of
controls near obstacles. This means the CBF constraint is tighter by
default, so phi has LESS room to make a difference. If phi still learns
proximity-adaptive behavior here, it's a strong result.
