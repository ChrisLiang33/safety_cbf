"""
Exp 57: A* navigation + safety filter -- fully randomized eval.
Action is [alpha, phi]. kx, ky from A* path planner.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 57: A* Nav + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
