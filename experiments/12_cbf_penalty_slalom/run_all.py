"""
One-shot: train CBF-penalty slalom model then evaluate.

Usage:
    cd experiments/12_cbf_penalty_slalom
    python run_all.py
"""
import subprocess
import sys
...
SCRIPTS = [
    ("Train CBF-penalty slalom model (kx, ky, alpha)", [sys.executable, "train_dynamic.py"]),
