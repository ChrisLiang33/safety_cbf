"""
One-shot: train alpha-only squeeze gate model then evaluate.
Fixed alpha baselines are deterministic (no training needed).
...
SCRIPTS = [
    ("Train alpha-only squeeze gate model", [sys.executable, "train_dynamic.py"]),
