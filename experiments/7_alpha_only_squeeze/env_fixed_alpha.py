"""
2-obstacle fixed-alpha CBF environment — squeeze gate design.
...
class FixedAlpha2ObsEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        path_y_at_gate = target_y * obs_x / 10.0
