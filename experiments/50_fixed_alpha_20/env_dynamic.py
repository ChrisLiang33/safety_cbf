"""
Exp 50: Fixed alpha=2.0 + combined best setup.
Agent controls [kx, ky, phi]. Alpha is FIXED at 2.0.

Alpha=2.0 is more aggressive than 1.0 — it allows a larger set of
controls near obstacles. The CBF constraint is looser by default,
meaning the robot can go faster near obstacles. This makes phi MORE
critical — without phi adding a robustness margin, the robot will
get dangerously close. Phi has more room and more reason to act.
