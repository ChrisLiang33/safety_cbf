"""Exp 50: Fixed alpha=2.0 + combined best, 10M steps."""
import time
...
if __name__ == "__main__":
    print("Exp 50: Fixed alpha=2.0 + combined best (kx, ky, phi)")
    ...
    env_fns = [lambda: FixedAlpha20Env() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 50: {elapsed:.1f}s ({elapsed/60:.1f}min)")
