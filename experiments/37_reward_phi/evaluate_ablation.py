"""
Exp 37: Reward Phi -- evaluate with bias + radius noise.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 37: REWARD PHI (bias=0.7, error=-1.0)",
                 fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 37 (Reward Phi): Alpha & Phi vs Distance to Nearest Obstacle (all scenarios)",
                     fontsize=14)
