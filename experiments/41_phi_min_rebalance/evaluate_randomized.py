"""
Exp 41: Phi Min Rebalance -- fully randomized eval.
Each scenario samples its own bias magnitude, obstacle radii, and radius errors.
Action is [kx, ky, alpha, phi]. Phi range [0.5, 10.0].
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 41: PHI MIN REBALANCE (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 41 (Phi Min Rebalance): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
