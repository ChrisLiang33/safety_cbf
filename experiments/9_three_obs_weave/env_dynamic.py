"""
3-obstacle weave on 100m map. Agent controls [kx, ky, alpha].

Obstacles at alternating y positions force the agent to weave (slalom).
The agent must learn:
  - Navigate efficiently (kx, ky)
  - Raise alpha in open space for speed
  - Lower alpha near obstacles for safety
  - Raise alpha again after passing each obstacle
"""
...
class ThreeObsWeaveDynamicEnv(gym.Env):
    def __init__(self):
        super().__init__()
        self.dt = 0.1
        ...
        #        rel_tgt_xy, tgt_r, vel_xy]  = 14 dims
