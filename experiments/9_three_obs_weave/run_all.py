"""
One-shot: train 3-obstacle weave model then evaluate.

Usage:
    cd experiments/9_three_obs_weave
    python run_all.py
"""
import subprocess
import sys
...
SCRIPTS = [
    ("Train 3-obs weave model (kx, ky, alpha)", [sys.executable, "train_dynamic.py"]),
