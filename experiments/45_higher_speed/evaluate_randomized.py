"""
Exp 45: Higher speed -- fully randomized eval.
Max speed 6 m/s, larger environment (target at x=150).
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 45: HIGHER SPEED 6 m/s (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 45 (Higher Speed 6 m/s): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
