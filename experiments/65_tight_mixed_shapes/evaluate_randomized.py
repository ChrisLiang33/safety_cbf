"""
Exp 65: A* + tighter mixed obstacle shapes -- fully randomized eval.
Action is [alpha, phi]. 5 obstacles: circles, rectangles, line segments.
Tighter spacing (y in [-6,6], 5 x-bands) forces narrow gaps.
...
from env_dynamic import AStarTightMixedShapesEnv, CIRCLE, RECTANGLE, LINE
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 65: A* + Tight Mixed Shapes + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
