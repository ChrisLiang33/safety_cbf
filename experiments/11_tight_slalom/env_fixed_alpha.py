"""
3-obstacle tight slalom, fixed alpha + proportional k_nom baseline.
Obstacles at y=±2-4 (tighter than standard slalom).
"""
...
class FixedAlphaThreeObsEnv(gym.Env):
