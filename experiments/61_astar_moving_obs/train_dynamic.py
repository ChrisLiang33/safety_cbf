"""Exp 61: A* + moving obstacles, 10M steps."""
import time
...
if __name__ == "__main__":
    print("Exp 61: A* + moving obstacles (alpha, phi)")
    ...
    env_fns = [lambda: AStarMovingObsEnv() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 61: {elapsed:.1f}s ({elapsed/60:.1f}min)")
