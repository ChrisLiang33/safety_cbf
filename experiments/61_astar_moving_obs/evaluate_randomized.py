"""
Exp 61: A* + MOVING obstacles -- fully randomized eval.
Action is [alpha, phi]. 3 circular obstacles that move during episodes.
...
from env_dynamic import AStarMovingObsEnv
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 61: A* + Moving Obstacles + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
