"""
Exp 47: Fixed Alpha + Higher Speed -- fully randomized eval.
...
from env_dynamic import FixedAlphaHigherSpeedEnv
...
if __name__ == "__main__":
    ...
    fig.suptitle(f"Exp 47: FIXED ALPHA={FIXED_ALPHA} + HIGHER SPEED (fully randomized eval)",
                 fontsize=18, y=1.005)
    ...
    fig_agg.suptitle(f"Exp 47 (Fixed Alpha={FIXED_ALPHA}, 6 m/s): Speed & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
