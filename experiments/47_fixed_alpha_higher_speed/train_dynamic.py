"""Exp 47: Fixed alpha=1.0 + higher speed + two-level sensor error, 10M steps."""
import time
...
if __name__ == "__main__":
    print("Exp 47: Fixed alpha=1.0 + higher speed (kx, ky, phi)")
    ...
    env_fns = [lambda: FixedAlphaHigherSpeedEnv() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 47: {elapsed:.1f}s ({elapsed/60:.1f}min)")
