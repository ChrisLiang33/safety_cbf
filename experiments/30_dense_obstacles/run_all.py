...
Experiment 30: 6 dense obstacles + radius noise + constant bias.
  - 6 obstacles instead of 3 (tighter gaps)
  - Includes radius noise + constant bias + randomized placement

Usage:
    cd experiments/30_dense_obstacles
    python run_all.py
"""
import subprocess
import sys
