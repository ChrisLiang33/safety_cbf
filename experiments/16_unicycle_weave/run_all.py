"""
One-shot: train unicycle weave model then evaluate.

Usage:
    cd experiments/16_unicycle_weave
    python run_all.py
"""
import subprocess
import sys
...
SCRIPTS = [
    ("Train unicycle weave model (v, omega, alpha)", [sys.executable, "train_dynamic.py"]),
