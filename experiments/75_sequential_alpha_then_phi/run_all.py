"""Run all: Phase 1 (alpha) -> Phase 2 (phi) -> Evaluate."""
import subprocess, sys, time
SCRIPTS = [
    ("Phase 1: Learn Alpha (phi fixed)", [sys.executable, "train_phase1_alpha.py"]),
    ("Phase 2: Learn Phi (alpha frozen)", [sys.executable, "train_phase2_phi.py"]),
