"""
Exp 59: A* navigation + tighter obstacles → train alpha/phi.
Agent controls [alpha, phi] ONLY.

Based on Exp 57 with two changes:
  1. Tighter obstacle y-range: [-4, 4] instead of [-10, 10]
     Obstacles are near the direct path, forcing close encounters
  2. Reduced A* inflation: 0.5m instead of 1.0m
     A* plans paths closer to obstacles
...
GRID_X_RANGE = (-5, 165)
GRID_Y_RANGE = (-22, 22)
INFLATION_MARGIN = 0.5  # reduced margin — A* routes closer to obstacles
