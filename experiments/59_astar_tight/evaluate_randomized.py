"""
Exp 59: A* + tight obstacles -- fully randomized eval.
Action is [alpha, phi]. Obstacles y=[-4,4], inflation=0.5m.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 59: A* Tight + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
