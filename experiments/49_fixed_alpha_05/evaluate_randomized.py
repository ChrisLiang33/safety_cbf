"""
Exp 49: Fixed Alpha=0.5 -- fully randomized eval.
Each scenario samples systematic bias + jitter, obstacle radii, dynamics bias.
Action is [kx, ky, phi]. Alpha is FIXED at 0.5. Max speed 6 m/s.
...
if __name__ == "__main__":
    ...
    fig.suptitle(f"Exp 49: FIXED ALPHA={FIXED_ALPHA} (fully randomized eval)",
                 fontsize=18, y=1.005)
    ...
    fig_agg.suptitle(f"Exp 49 (Fixed Alpha={FIXED_ALPHA}, 6 m/s, collision -250): Speed & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
