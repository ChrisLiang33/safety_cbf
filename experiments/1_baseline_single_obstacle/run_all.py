"""
One-shot script: trains all models then runs evaluation.
Run this and go take a nap.
...
SCRIPTS = [
    ("Train fixed-alpha baselines", [sys.executable, "train_fixed_alphas.py"]),
    ("Train dynamic-alpha (optimized)", [sys.executable, "train_dynamic_optimized.py"]),
