"""
2-obstacle ablation with CBF intervention penalty.
Key question: does penalizing ||safe_u - k_nom|| cause alpha to recover between obstacles?
...
if __name__ == "__main__":
    ...
    fig.suptitle(r"2-Obstacle + CBF Penalty: Fixed $\alpha$ vs Dynamic $\alpha$", fontsize=16, y=1.01)
    ...
    # =====================================================================
    fig, axs = plt.subplots(len(SCENARIOS), 1, figsize=(10, 4 * len(SCENARIOS)))
    fig.suptitle(r"Dynamic $\alpha$ Adaptation Over Time (2 Obs + CBF Penalty)", fontsize=16, y=1.01)
    ...
    fig.suptitle(f"Aggregate Metrics — 2 Obs + CBF Penalty ({N_RANDOM_SCENARIOS} Random Scenarios)", fontsize=16)
