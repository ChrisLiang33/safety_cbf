"""
2-obstacle fixed-alpha CBF environment with CBF intervention penalty.
Agent outputs [k_x, k_y] only. Alpha is baked in.
Reward penalizes ||safe_u - k_nom|| to discourage unnecessary CBF intervention.
"""
...
class MultiObstacleFixedAlphaEnv(gym.Env):
