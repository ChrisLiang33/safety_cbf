"""
One-shot: train all models then evaluate (2-obstacle version).
...
SCRIPTS = [
    ("Train fixed-alpha baselines (2 obs)", [sys.executable, "train_fixed_alphas.py"]),
    ("Train dynamic-alpha (2 obs)", [sys.executable, "train_dynamic.py"]),
    ("Evaluate ablation (2 obs)", [sys.executable, "evaluate_ablation.py"]),
]
