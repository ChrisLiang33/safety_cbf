"""
Exp 53: SHIELD SDF pipeline -- fully randomized eval.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 53: SHIELD SDF PIPELINE (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 53 (SHIELD SDF Pipeline): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
