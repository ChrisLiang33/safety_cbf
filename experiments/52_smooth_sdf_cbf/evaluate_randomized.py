"""
Exp 52: Smooth SDF-based CBF -- fully randomized eval.
h = lambda*(1 - e^{-gamma*sdf}), saturates far from obstacles.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 52: SMOOTH SDF-BASED CBF (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 52 (Smooth SDF-Based CBF): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
