"""
Experiment 36: ISSf-CBF with ONLY radius estimation noise (no bias).
Isolates perception uncertainty to test if phi compensates for wrong radius.

Usage:
    cd experiments/36_issf_radius_noise_only
    python run_all.py
"""
