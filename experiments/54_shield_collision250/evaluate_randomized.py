"""
Exp 54: SHIELD SDF + collision -250 -- fully randomized eval.
Eq 19-22: min SDF -> smooth -> concave approx -> piecewise.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 54: SHIELD SDF + COLLISION -250 (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 54 (SHIELD SDF + Collision -250): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
