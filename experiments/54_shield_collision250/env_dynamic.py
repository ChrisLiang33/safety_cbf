"""
Exp 54: SHIELD SDF + collision penalty -250.
Agent controls [kx, ky, alpha, phi].

Same as Exp 53 (SHIELD SDF pipeline Eq 19-22) but with collision -250
instead of -100. Compare to Exp 46 (squared CBF + collision -250) to
see if the SHIELD formulation changes phi behavior.
...
class ShieldCollision250Env(gym.Env):
