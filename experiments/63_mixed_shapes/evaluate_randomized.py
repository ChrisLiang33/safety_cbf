"""
Exp 63: A* + mixed obstacle shapes -- fully randomized eval.
...
from env_dynamic import AStarMixedShapesEnv, CIRCLE, RECTANGLE, LINE
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 63: A* + Mixed Shapes + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
