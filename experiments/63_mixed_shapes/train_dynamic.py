"""Exp 63: A* (stochastic) + mixed obstacle shapes, 10M steps."""
import time
from stable_baselines3 import PPO
from stable_baselines3.common.vec_env import SubprocVecEnv
from env_dynamic import AStarMixedShapesEnv

TOTAL_TIMESTEPS = 10_000_000
N_ENVS = 16

if __name__ == "__main__":
    print("Exp 63: Stochastic A* + mixed shapes (alpha, phi)")
    ...
    env_fns = [lambda: AStarMixedShapesEnv() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 63: {elapsed:.1f}s ({elapsed/60:.1f}min)")
