"""
Exp 66: A* + 8 mixed obstacle shapes -- fully randomized eval.
Action is [alpha, phi]. 8 obstacles: circles, rectangles, line segments.
...
from env_dynamic import AStarMoreMixedShapesEnv, CIRCLE, RECTANGLE, LINE
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 66: A* + 8 Mixed Shapes + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
