"""Exp 43: Fixed alpha=1.0, learned phi only, 10M steps."""
import time
...
if __name__ == "__main__":
    ...
    vec_env.close()
    print(f"\n>> Exp 43: {elapsed:.1f}s ({elapsed/60:.1f}min)")
