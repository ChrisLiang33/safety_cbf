"""
Exp 42: High Collision Penalty -- fully randomized eval.
Each scenario samples its own bias magnitude, obstacle radii, and radius errors.
Action is [kx, ky, alpha, phi]. Collision penalty = -500.
...
from env_dynamic import HighCollisionPenaltyEnv
...
def plot_trajectory(ax, scen, r, fontsize_title=11, fontsize_label=None, fontsize_legend=None,
    ...
    ax.text(95, -13, f"avg_err={avg_err:.2f}m",
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 42: HIGH COLLISION PENALTY (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 42 (High Collision Penalty): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
