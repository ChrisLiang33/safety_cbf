"""
Exp 42: Collision Penalty -500 -- evaluate with bias + radius noise.
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 42: COLLISION PENALTY -500 (bias=0.7, error=-1.0)",
                 fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 42 (Collision Penalty -500): Alpha & Phi vs Distance to Nearest Obstacle (all scenarios)",
                     fontsize=14)
