"""
Exp 56: Sequential frozen nav + safety filter -- fully randomized eval.
Action is [alpha, phi]. kx, ky from frozen nav policy.
...
from env_safety_filter import SafetyFilterEnv
...
if __name__ == "__main__":
    ...
    print("Loading model...")
    env = SafetyFilterEnv(nav_model_path=NAV_MODEL_PATH)
    ...
    fig.suptitle("Exp 56: Sequential Frozen Nav + Alpha/Phi (fully randomized eval)",
                 fontsize=18, y=1.005)
