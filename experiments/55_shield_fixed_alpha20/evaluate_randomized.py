"""
Exp 55: SHIELD SDF + Fixed Alpha=2.0 -- fully randomized eval.
SHIELD pipeline (Eq 19-22) + fixed alpha + collision -250.
...
from env_dynamic import ShieldFixedAlpha20Env
...
if __name__ == "__main__":
    ...
    fig.suptitle(f"Exp 55: SHIELD + FIXED ALPHA={FIXED_ALPHA} (fully randomized eval)",
                 fontsize=18, y=1.005)
    ...
    fig_agg.suptitle(f"Exp 55 (SHIELD + Fixed Alpha={FIXED_ALPHA}, collision -250): Speed & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
