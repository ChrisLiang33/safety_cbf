...
Same constant bias as env_dynamic.py but without the ISSf-CBF phi term.
Used as the ablation baseline to show whether phi adds value against persistent bias.
"""
...
class AlphaOnlyConstantBiasEnv(gym.Env):
