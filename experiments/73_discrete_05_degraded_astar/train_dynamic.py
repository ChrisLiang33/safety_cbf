"""Exp 73: Discrete A* (degraded) + moving obstacles, 10M steps."""
import time
from stable_baselines3 import PPO
from stable_baselines3.common.vec_env import SubprocVecEnv
from env_dynamic import DiscreteAStarDegradedEnv

TOTAL_TIMESTEPS = 10_000_000
N_ENVS = 16

if __name__ == "__main__":
    print("Exp 73: Discrete A* DEGRADED + moving obstacles (alpha/phi step=0.5)")
    ...
    env_fns = [lambda: DiscreteAStarDegradedEnv() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 73: {elapsed:.1f}s ({elapsed/60:.1f}min)")
