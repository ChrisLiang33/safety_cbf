"""
Exp 58: Sequential easy nav + hard safety -- fully randomized eval.
Action is [alpha, phi]. kx, ky from frozen easy nav policy.
...
MODEL_PATH = "./models_dynamic/safety_filter_model"
...
def generate_scenarios(n=10, seed=42):
    ...
    for i in range(n):
        ...
        for x_low, x_high in x_bands:
            ...
            y = rng.uniform(-6.0, 6.0)  # tighter y — obstacles near center
...
if __name__ == "__main__":
    ...
    env = SafetyHardEnv(nav_model_path=NAV_MODEL_PATH)
    ...
    fig.suptitle("Exp 58: Easy Nav (frozen) + Hard Safety (fully randomized eval)",
                 fontsize=18, y=1.005)
