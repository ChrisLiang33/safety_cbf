"""
Exp 46: Combined best -- fully randomized eval.
Max speed 6 m/s, larger environment, collision -250, systematic sensor error.
...
from env_dynamic import CombinedBestEnv
...
if __name__ == "__main__":
    ...
    fig.suptitle("Exp 46: COMBINED BEST (6 m/s, collision -250) (fully randomized eval)", fontsize=18, y=1.005)
    ...
    fig_agg.suptitle("Exp 46 (Combined Best: 6 m/s + collision -250): Alpha & Phi vs Distance (fully randomized eval)",
                     fontsize=14)
