"""
Exp 46: Combined best — higher speed + systematic sensor error + higher collision penalty.
Agent controls [kx, ky, alpha, phi].

Combines the best components from previous experiments:
  - From Exp 44: systematic sensor error model (bias + jitter)
  - From Exp 45: higher max speed (6 m/s), larger environment
  - From Exp 42: higher collision penalty (-250, moderate between -100 and -500)
