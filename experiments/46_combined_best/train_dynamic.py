"""Exp 46: Combined best — higher speed + systematic sensor error + collision -250, 10M steps."""
import time
...
if __name__ == "__main__":
    print("Exp 46: Combined best (kx, ky, alpha, phi)")
    ...
    env_fns = [lambda: CombinedBestEnv() for _ in range(N_ENVS)]
    ...
    vec_env.close()
    print(f"\n>> Exp 46: {elapsed:.1f}s ({elapsed/60:.1f}min)")
