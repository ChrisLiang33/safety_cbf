"""
One-shot: train disturbance weave model then evaluate.

Usage:
    cd experiments/13_disturbance_weave
    python run_all.py
"""
import subprocess
import sys
...
SCRIPTS = [
    ("Train disturbance weave model (kx, ky, alpha)", [sys.executable, "train_dynamic.py"]),
